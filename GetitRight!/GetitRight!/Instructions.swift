...
Implement the unit test cases using XCTest/XCUITest
...
4.      Add the email address of Photon Point of Contact as a “Master or Maintainer” to your project:
            User Name: Shyam-Photon/ Photon PoC email ids: Shyam.su1@photon.com
 
5. Also share your public project link or entire code Repo Zip file to the recruiter.
*/
